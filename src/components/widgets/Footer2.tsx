...
const Footer2 = () => {
  ...
  return (
    <div className="px-4 mx-auto max-w-7xl sm:px-6">
      <div className="grid grid-cols-4 gap-4 py-8 xs:gap-8 gap-y-8 md:py-12">
        ...
        <div className="col-span-4 sm:col-span-2 md:col-span-2 lg:col-span-1 xl:col-span-1">
          <div className="mb-2 font-medium text-gray-800 dark:text-gray-300">Sotsiaalmeedia</div>
          <ul className="flex mb-4 -ml-2 md:order-1 md:mb-0">
      ...
      <div className="py-6 text-sm text-gray-700 text-muted dark:text-slate-400 md:flex md:items-center md:justify-between md:py-8">
        <ul className="flex pl-2 mb-4 -ml-2 md:order-1 md:mb-0">
          {links &&
